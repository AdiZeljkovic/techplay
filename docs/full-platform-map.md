...
flowchart TB
    ...
    subgraph FE["🖥️  FRONTEND — Next.js 16 — techplay.gg"]
        ...
        FCO["💬 Forum · Profil · Prijatelji · Clans · Messages"]
    ...
    subgraph BE["⚙️  BACKEND — Laravel 12 — api.techplay.gg/api/v1"]
        ...
        BA3["Community: /forum · /comments · /friends · /messages · /clans"]
    ...
    subgraph DATABASE["🗄️  BAZA — PostgreSQL + Redis"]
        ...
        DB3["Community: users · ranks · threads · posts · comments · messages · friendships · clans"]
