    ...
    @else
        <div class="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
            <div class="flex items-center gap-2 text-blue-700 dark:text-blue-300">
                ...
                <div>
                    <p class="font-semibold text-sm">Total Participants: {{ $entries->count() }}</p>
                    <p class="text-xs mt-0.5">Total Points Pool: {{ number_format($totalPool) }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <p class="text-xs text-gray-600 dark:text-gray-400 text-center">
                ...
                Winner will be selected using weighted random algorithm. Higher points = better chance to win.
            </p>
        </div>
    @endif
</div>
