...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('throttle:60,1')->group(function () {
        ...
        Route::get('/games/rawg/{slug}/screenshots', [App\Http\Controllers\Api\V1\GameController::class, 'rawgScreenshots']);
        Route::get('/games/rawg/{slug}/movies',      [App\Http\Controllers\Api\V1\GameController::class, 'rawgMovies']);
        Route::get('/games/rawg/{slug}/suggested',   [App\Http\Controllers\Api\V1\GameController::class, 'rawgSuggested']);
