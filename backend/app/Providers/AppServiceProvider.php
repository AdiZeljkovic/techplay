...
use App\Observers\HelpCategoryObserver;
...
use App\Observers\UserDropdownObserver;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        GameRating::observe(GameRatingObserver::class);
        Product::observe(ProductObserver::class);
        Thread::observe(ThreadObserver::class);
        Post::observe(ForumPostObserver::class);
        Guide::observe(GuideObserver::class);
        HelpArticle::observe(HelpArticleObserver::class);
        HelpCategory::observe(HelpCategoryObserver::class);
        User::observe(UserDropdownObserver::class);
