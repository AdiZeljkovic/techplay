...
export async function generatePageMetadata(
    ...
    const description = pageSeo?.meta_description || defaults?.description || settings.seo_meta_description || "Your source for gaming news, reviews, and hardware analysis.";
