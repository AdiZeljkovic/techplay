...
/**
 * The skeleton belongs to the listing, not to everything under /reviews.
 *
 * It used to sit at app/reviews/loading.tsx, which wraps the whole subtree in a
 * Suspense boundary — including /reviews/{slug}. Next flushes the shell as soon
