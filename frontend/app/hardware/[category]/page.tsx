...
export default function HardwareCategoryPage({ params }: CategoryPageProps) {
    const [page, setPage] = useState(1);

    // Find the category config based on URL slug
    const currentCategory = HARDWARE_CATEGORIES.find(c => c.slug === params.category);
    ...
    return (
        <div className="min-h-screen bg-[var(--bg-primary)]">
            ...
            <PageHero
                ...
                description={currentCategory.label === "Reviews" ? "Comprehensive hardware reviews." : `Latest ${currentCategory.label} in the Hardware Lab.`}
