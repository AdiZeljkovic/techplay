            ...
            <div className="flex flex-col lg:flex-row gap-4 p-4 pl-5">
                ...
                <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1.5 flex flex-wrap items-center gap-1.5">
                        ...
                        {pick.released && (
                            <span className="inline-flex items-center gap-1 font-display text-[10px] font-bold tabular-nums text-white/45">
                ...
                <div className="flex lg:flex-col items-center lg:items-end justify-between gap-3 shrink-0">
                    ...
                    >
                        <span className="block font-display text-[8.5px] font-bold uppercase tracking-[0.14em] text-white/50">Match score</span>
                        ...
                        <span className="mt-1 inline-flex items-center gap-1 font-display text-[8.5px] font-bold uppercase tracking-[0.1em] text-white/45 hover:text-white/50 transition-colors">
                    ...
                    <div className="mt-6 flex flex-wrap items-center justify-center gap-2">
                        ...
                        {(summary?.top_genres?.length ?? 0) > 0 && (
                            <span className="inline-flex items-center gap-2 h-8 px-3.5 rounded-full bg-white/[0.05] border border-white/[0.08] backdrop-blur-sm">
                                ...
                                <span className="font-display text-[9px] font-bold uppercase tracking-[0.12em] text-white/50">You play most</span>
                            </span>
                        )}
                    </div>
                </div>
            ...
            <div className="container-page py-6 grid grid-cols-1 xl:grid-cols-12 gap-5 items-start">
                ...
                <aside className="xl:col-span-3 min-w-0 space-y-5">
                    ...
                    <Panel variant="console" title="Backlog health">
                        ...
                        <p className="mt-5 pt-4 border-t border-white/[0.07] font-display text-[9px] font-black uppercase tracking-[0.14em] text-white/55">
                            ...
                            {(data?.weights ?? []).map((w) => (
                                <div key={w.key} className="flex items-start gap-2.5">
                                    ...
                                    <span className="min-w-0">
                                        ...
                                        <span className="block mt-0.5 text-[10.5px] text-white/55 leading-snug">{w.note}</span>
                                    </span>
                                </div>
                            ))}
                        </div>
                    ...
                    <Panel title="Refine">
                        <p className="font-display text-[9px] font-black uppercase tracking-[0.14em] text-white/55 mb-2">Mood</p>
                        ...
                        <p className="flex items-center justify-between font-display text-[9px] font-black uppercase tracking-[0.14em] text-white/55 mb-2">
                            Genres
                            {genres.length > 0 && (
                                <button onClick={() => setGenres([])} className="inline-flex items-center gap-1 normal-case tracking-normal text-[10px] font-bold text-white/50 hover:text-white">
                        ...
                        {(data?.genres.length ?? 0) > 6 && (
                            <button
                                ...
                                className="inline-flex items-center gap-1 font-display text-[10px] font-bold text-white/55 hover:text-[var(--accent)] transition-colors mb-5"
                            >
                                {showAllGenres ? "Show fewer" : "See all"} <ChevronDown className={`w-3 h-3 transition-transform ${showAllGenres ? "rotate-180" : ""}`} />
                            </button>
                        )}

                        <p className="font-display text-[9px] font-black uppercase tracking-[0.14em] text-white/55 mb-2 mt-1">Exclude</p>
