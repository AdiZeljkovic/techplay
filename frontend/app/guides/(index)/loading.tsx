...
/**
 * The skeleton belongs to the listing, not to everything under /guides.
 *
 * It used to sit at app/guides/loading.tsx, which wraps the whole subtree in a
 * Suspense boundary — including /guides/{slug}. Next flushes the shell as soon
