            ...
            <div className="relative max-w-[1320px] mx-auto px-4 xl:px-8 py-12 md:py-16 flex flex-col justify-center min-h-[560px] md:min-h-[660px]">
                ...
                >
                        ...
                        <div className="flex flex-wrap items-end gap-x-6 gap-y-4 mb-8">
                            <div>
                                <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#71717A] mb-1">Release Date</p>
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            <button
                                ...
                                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[var(--gta-pink)] text-white text-[13px] font-bold uppercase tracking-wide hover:bg-[#ff1a7a] transition-colors gta6-glow-pink"
                            >
                                <ShoppingCart className="w-4 h-4" /> Pre-order Now
                            </button>
                            <button
                                onClick={() => scrollTo("trailers")}
                                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-white/8 border border-white/25 text-white text-[13px] font-bold uppercase tracking-wide hover:border-[var(--gta-cyan)]/60 hover:bg-white/12 transition-colors backdrop-blur-sm"
                            >
