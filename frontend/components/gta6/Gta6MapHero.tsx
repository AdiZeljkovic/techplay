...
export default function Gta6MapHero({ totalLocations }: Gta6MapHeroProps) {
    ...
    return (
        <div className="relative bg-[#0B0E14] border-b border-[#161B22] overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[var(--accent)]/8 via-transparent to-transparent" />
            <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-[var(--accent)]/40 via-[var(--accent)]/10 to-transparent" />

            <div className="relative max-w-[1320px] mx-auto px-4 xl:px-8 py-4 md:py-5">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-6">
                    {/* Left: icon + title */}
                    <div className="flex items-center gap-3">
                        <div className="hidden sm:flex w-11 h-11 rounded-xl bg-[var(--accent)]/12 border border-[var(--accent)]/30 items-center justify-center shrink-0">
                            <MapIcon className="w-5 h-5 text-[var(--accent)]" />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-2 md:gap-2.5 flex-wrap">
                        ...
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-[var(--accent)]/10 border border-[var(--accent)]/25 text-[12px] text-[var(--accent)] font-semibold">
