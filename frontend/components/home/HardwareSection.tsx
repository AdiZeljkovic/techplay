...
export default function HardwareSection({ articles }: HardwareSectionProps) {
    ...
    return (
        <div className="flex flex-col h-full w-full">
            <div className="flex items-end justify-between font-sans mb-5 border-b border-zinc-200 dark:border-white/10 pb-[10px]">
                ...
                <Link href="/hardware" className="text-tp-accent hover:text-tp-accent-hover transition-colors text-[11px] font-bold uppercase tracking-widest flex items-center gap-1.5 group pb-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[30px] w-full">
                ...
                <div className="flex flex-col justify-between">
                    {list.map((article, i) => (
                        <Link key={article.id} href={`/hardware/${article.slug}`} className={`group flex gap-[20px] pb-[16px] pt-[8px] ${i !== list.length - 1 ? "border-b border-zinc-200 dark:border-[#27272A]/80" : "mb-0 pb-0"}`}>
