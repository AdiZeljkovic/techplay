 ...
 *
 * One implementation, re-exported by each section's error.tsx. There were
 * thirteen byte-identical copies of this file, and the four sections most
 * likely to throw — studios, lists, gta6 and author, all of which call the
 * throwing fetchContent — had none of them. Copies do not stay identical: the
 * next person to improve the wording improves one of seventeen.
 */
