...
export default function GuideDetailView({ guide, userVote: initialVote }: GuideDetailViewProps) {
    ...
    return (
                            ...
                            <div className="relative w-full rounded-[24px] flex flex-col overflow-hidden bg-[#0B0E14] border border-[#161B22] h-[580px]">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex flex-col">
                                                <span className="text-[#E4E4E5] font-medium text-[14px]">
                                                    By <strong>{decodeHtml(guide.author?.display_name || guide.author?.username || "TechPlay Editor")}</strong>
                                                </span>
                                ...
                                <div className="relative z-20 flex flex-col md:flex-row md:items-center justify-between border-t border-white/[0.05] bg-[#0A0D12] px-8 md:px-12 py-4 gap-4">
                                    <div className="flex items-center flex-wrap gap-3">
                                        <span className="text-[#71717A] text-[11px] font-bold uppercase tracking-widest mr-2">HELPFUL:</span>
        ...
        <Dialog open={showLoginPrompt} onOpenChange={setShowLoginPrompt}>
            <div className="bg-[#0B0E14] border border-[#161B22] rounded-2xl p-8 max-w-sm w-full shadow-2xl text-center">
                ...
                <div className="flex gap-3">
                    <button
                        ...
                        className="flex-1 py-2.5 px-4 rounded-lg border border-[#161B22] text-[#A1A1AA] text-sm font-medium hover:bg-white/5 transition-colors"
                    >
                        Maybe later
                    </button>
                    <Link
