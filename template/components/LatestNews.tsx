  ...
  return (
    <div className="flex flex-col h-full w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-[30px] w-full">
        ...
        {/* Large Featured Card */}
        <Link href={`/news/${featured.slug}`} className="group relative rounded-xl overflow-hidden flex flex-col w-full min-h-[460px] border border-zinc-200 dark:border-white/5 shadow-sm dark:shadow-none bg-white dark:bg-[#05070A] transition-colors duration-300">
        ...
        <div className="flex flex-col justify-between">
          {list.map((article, i) => (
            <Link key={i} href={`/news/${article.slug}`} className={`group flex gap-[20px] pb-[16px] pt-[8px] ${i !== list.length -1 ? 'border-b border-zinc-200 dark:border-[#27272A]/80' : 'mb-0 pb-0'}`}>
